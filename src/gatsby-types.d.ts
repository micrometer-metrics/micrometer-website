...
type SITE_METADATA_QUERYQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly siteUrl: string | null, readonly keywords: ReadonlyArray<string | null> | null, readonly image: string | null } | null } | null };
